...
def main(epsilon: float = 5, number_density: float = 0.2, rho: float = 33, num_types: int = 2,
    ...
    :param num_types: Number of different particle sizes.
    ...
    # Determine the type for each particle; probability of type 1 is p1, etc.
    if num_types == 2:
        print("bidisperse")
        ...
        raise ValueError("num_types must be 1 or 2")
