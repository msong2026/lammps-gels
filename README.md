# lammps-gels
This is a repository for LAMMPS simulations of percolation in monodisperse and bidisperse colloidal gels. The gel initialization scripts (gel_setup_bidisperse.py) are adapted from https://github.com/merrygoat/creep-sheared-gels.
...
Note that .dump files were not uploaded for most simulations to reduce clutter. They were kept for sim-11-bidisperse-0.9.
